...
exports.handler = async (event) => {
  ...
  try {
    ...
    const raw = (W.brand[v.brandTier] || 0) + (W.decade[v.decade] || 0) + (W.cond[v.cond] || 0) + (W.size[v.size] || 0) + (W.season[v.season] || 0) + (W.price[priceFactor] || 0) + (W.digital[v.digital] || 0) + (W.cannibal[v.cannibal] || 0) + (CAT_BOOST[v.cat] || 0);
    ...
    if (daysInShop > 45) insights.push({ type: 'neg', text: 'Oltre 45 giorni: valuta sconto 20-30%.' });
